// const CONFIG_URL        = "https://raw.githubusercontent.com/TeaTV/TeaTV-add-ons/master/add-ons/config.json";
const CONFIG_URL        = "http://localhost:8000/config.json";
const libs              = require("../libs/index.rn");
...
class LoadAddOns {
    constructor(props) {
        ...
        this.libs               = libs;
        this.CONFIG_URL         = this.platform === "android" ? "http://10.0.2.2:8000/config_android.json" : CONFIG_URL;
        this.state              = {
            dbPath: props.dbPath,
            addOnsUrl: "",
            all_provider: {},
